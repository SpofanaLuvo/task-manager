...
const MembershipCard = ({ name, memberId, tier }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        ref={cardRef}
        className="bg-black text-goldwhite shadow-lg rounded-lg w-80 p-6 border-t-4 border-gold"
